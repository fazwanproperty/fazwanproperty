...
## Tadbir.site - live legal practice management

[![Tadbir.site - Legal Practice Management](assets/tadbir-site-banner.svg)](https://tadbir.site)

[Tadbir.site](https://tadbir.site) is a live legal-practice management platform built for Malaysian law firms. It is a separate founder-led product in my portfolio, focused on making complex practice administration clearer and easier to govern.
...
|---|---|---|
| 9 Sep 2026 | Validation | Prepared and structurally verified a seven-slide SME discovery package with a tailored conversation script, original visual asset, speaker notes, and a controlled demo-data prompt. This records preparation only; no meeting, prospect interest, customer conversion, or revenue outcome is claimed. |
